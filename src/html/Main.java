...
public class Main {
    ...
    public static void main(String[] args) {
        parse("HTML allows <i>italic text to have <i>nested italics</i> as well</i>.  Markdown can't do that.");
    }
     ...
     */
     public static void parse(String string) {
        ...
        // Make a parser
        HtmlParser parser = makeParser(stream);
...
//        return listener.bombs;
      ...
      * 
      */
     private static HtmlParser makeParser(CharStream stream) {
